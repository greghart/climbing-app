...
import { Field, GenericFieldHTMLAttributes, BaseFieldProps } from 'redux-form';
...
type FieldType = React.ComponentType<(GenericFieldHTMLAttributes | BaseFieldProps) & Props>;
